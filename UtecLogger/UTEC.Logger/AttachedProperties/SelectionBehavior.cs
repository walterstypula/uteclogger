...
namespace UTEC.Logger.AttachedProperties
{
	/// <summary>
	/// Description of SelectionBehavior.
	/// </summary>
	public class SelectionBehavior
	{
		public static DependencyProperty SelectionChangedProperty =       
			DependencyProperty.RegisterAttached("SelectionChanged", typeof(ICommand), typeof(SelectionBehavior), new UIPropertyMetadata(SelectionBehavior.SelectedItemChanged));    
