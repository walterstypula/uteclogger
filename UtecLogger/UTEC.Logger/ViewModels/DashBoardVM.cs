...
namespace UTEC.Logger.ViewModels
{
    ...
    public class DashBoardVM : ViewModelBase
    {
        ...
        private void UpdateDashBoardDisplay()
        {
            ...
            OnPropertyChanged(nameof(MAFV));
            OnPropertyChanged(nameof(TPS));
            OnPropertyChanged(nameof(Load));
            OnPropertyChanged(nameof(Knock));
            OnPropertyChanged(nameof(ECUIGN));
            OnPropertyChanged(nameof(IDC));
            OnPropertyChanged(nameof(IGN));
            OnPropertyChanged(nameof(MAPVE));
            OnPropertyChanged(nameof(MODMAFV));
            OnPropertyChanged(nameof(AFR));
        }

        public string UtecData
        {
            get { return this.Get<string>(nameof(UtecData)); }
            set
            {
                this.Set<string>(nameof(UtecData), value);
            }
        }
        ...
        public string[] UtecDataArray
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(UtecDataArray));
            }
        }
