...
namespace UTEC.Logger.ViewModels
{
    ...
    public class UserSettingsVM : ViewModelBase
    {
        ...
        private void UserSettingsVM_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            switch (e.PropertyName)
            {
                case nameof(IsSettingsPanelVisible):
        ...
        private List<int> _linesPerSecondOptions = new List<int>();
        ...
        private List<string> GetWBDataSources()
        {
        ...
        {
            get { return this.Get<bool>(nameof(IsSettingsPanelVisible), false); }
            set { this.Set<bool>(nameof(IsSettingsPanelVisible), value); }
        }
        ...
        {
            get { return this.Get<Settings>(nameof(Settings)); }
            set { this.Set<Settings>(nameof(Settings), value); }
        }
